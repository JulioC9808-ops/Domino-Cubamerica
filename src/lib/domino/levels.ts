...
export const RANK_TIERS: RankTier[] = [
  { id: "novato", label: "novato", min: 0, color: "oklch(0.68 0.03 250)" },
  { id: "cuartelero", label: "cuartelero", min: 750, color: "oklch(0.7 0.07 110)" },
  { id: "el-chiva", label: "elChivato", min: 900, color: "oklch(0.7 0.09 145)" },
  { id: "tranquero", label: "tranquero", min: 1100, color: "oklch(0.7 0.13 200)" },
  { id: "sabroso", label: "sabroso", min: 1300, color: "oklch(0.74 0.16 47)" },
  { id: "matador", label: "matador", min: 1450, color: "oklch(0.72 0.17 25)" },
  { id: "capicua", label: "capicua", min: 1550, color: "oklch(0.7 0.18 15)" },
  { id: "la-tranka", label: "LaTranka", min: 1700, color: "oklch(0.8 0.16 60)" },
  { id: "maestro", label: "maestro", min: 1800, color: "oklch(0.85 0.14 88)" },
  { id: "leyenda", label: "leyenda", min: 2100, color: "oklch(0.88 0.12 120)" },
  { id: "el-puro", label: "El Puro", min: 2500, color: "oklch(0.92 0.15 95)" },
];
...
export const UNLOCKABLES: Unlockable[] = [
  ...
  { id: "colores", kind: "skin", label: "Puntos de colores", level: 14 },
  { id: "roble", kind: "skin", label: "Roble", level: 18 },
  { id: "caoba", kind: "skin", label: "Caoba", level: 24 },
  { id: "marmol", kind: "skin", label: "Mármol", level: 28 },
  { id: "jade", kind: "skin", label: "Jade", level: 33 },
  { id: "cromo", kind: "skin", label: "Cromo", level: 40 },
  { id: "oro", kind: "skin", label: "Oro viejo", level: 55 },
...
> = {
  hueso: {
    bone: "oklch(0.96 0.017 85)",
    boneEdge: "oklch(0.86 0.03 82)",
    pip: "oklch(0.24 0.03 260)",
  },
  colores: {
    bone: "oklch(0.97 0.012 250)",
    boneEdge: "oklch(0.88 0.02 250)",
    pip: "oklch(0.24 0.03 260)",
  },
  marfil: {
    bone: "oklch(0.97 0.03 95)",
    boneEdge: "oklch(0.88 0.05 92)",
    pip: "oklch(0.32 0.06 60)",
    texture: `repeating-linear-gradient(3deg, oklch(0.5 0.03 85 / 0.06) 0 1px, transparent 1px 6px)`,
  },
  obsidiana: {
    bone: "oklch(0.28 0.02 260)",
    boneEdge: "oklch(0.18 0.02 260)",
    pip: "oklch(0.92 0.02 260)",
    texture: `radial-gradient(circle at 30% 30%, oklch(1 0 0 / 0.06) 1px, transparent 1.6px) 0 0 / 7px 7px`,
  },
  caoba: {
    bone: "oklch(0.48 0.09 40)",
    boneEdge: "oklch(0.34 0.08 35)",
    pip: "oklch(0.95 0.02 80)",
  ...
  jade: {
    bone: "oklch(0.72 0.11 160)",
    boneEdge: "oklch(0.55 0.1 160)",
    pip: "oklch(0.2 0.04 160)",
    texture: `radial-gradient(60% 40% at 30% 25%, oklch(1 0 0 / 0.25), transparent 70%)`,
  },
  oro: {
    bone: "oklch(0.85 0.13 88)",
    boneEdge: "oklch(0.68 0.14 70)",
    pip: "oklch(0.26 0.05 60)",
    texture: `repeating-linear-gradient(90deg, oklch(1 0 0 / 0.1) 0 1px, transparent 1px 3px, oklch(0 0 0 / 0.08) 3px 4px, transparent 4px 6px)`,
  },
  neon: {
    bone: "oklch(0.32 0.05 300)",
    boneEdge: "oklch(0.2 0.05 300)",
    pip: "oklch(0.85 0.2 190)",
  },
  roble: {
    bone: "oklch(0.78 0.06 70)",
    boneEdge: "oklch(0.64 0.06 65)",
    pip: "oklch(0.3 0.05 50)",
    texture: `repeating-linear-gradient(91deg, oklch(0.2 0.06 60 / 0.16) 0 1px, transparent 1px 6px, oklch(1 0 0 / 0.08) 6px 7px, transparent 7px 13px)`,
  },
  marmol: {
    bone: "oklch(0.94 0.008 250)",
    boneEdge: "oklch(0.82 0.012 250)",
    pip: "oklch(0.4 0.03 250)",
    texture: `repeating-linear-gradient(110deg, transparent 0 10px, oklch(0.5 0.02 250 / 0.18) 10px 10.8px, transparent 10.8px 24px), radial-gradient(40% 30% at 70% 30%, oklch(1 0 0 / 0.5), transparent 70%)`,
  },
  cromo: {
    bone: "oklch(0.82 0.005 250)",
    boneEdge: "oklch(0.65 0.008 250)",
    pip: "oklch(0.35 0.02 250)",
    texture: `repeating-linear-gradient(90deg, oklch(1 0 0 / 0.14) 0 1px, transparent 1px 2.5px, oklch(0 0 0 / 0.08) 2.5px 3.5px, transparent 3.5px 6px)`,
  },
  estelar: {
    bone: "oklch(0.25 0.04 280)",
    boneEdge: "oklch(0.16 0.04 280)",
    pip: "oklch(0.9 0.08 90)",
    texture: `radial-gradient(1px 1px at 25% 30%, oklch(1 0 0 / 0.9), transparent), radial-gradient(1px 1px at 65% 60%, oklch(1 0 0 / 0.7), transparent), radial-gradient(1.5px 1.5px at 40% 80%, oklch(1 0 0 / 0.5), transparent) 0 0 / 22px 18px, radial-gradient(1px 1px at 85% 15%, oklch(1 0 0 / 0.8), transparent) 0 0 / 30px 26px`,
  },
};
