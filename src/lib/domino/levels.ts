...
> = {
  ...
  jade: {
    bone: "oklch(0.72 0.11 160)", boneEdge: "oklch(0.55 0.1 160)", pip: "oklch(0.2 0.04 160)",
    texture: `radial-gradient(60% 40% at 30% 25%, oklch(1 0 0 / 0.25), transparent 70%)`,
  },
  oro: {
    bone: "oklch(0.85 0.13 88)", boneEdge: "oklch(0.68 0.14 70)", pip: "oklch(0.26 0.05 60)",
  ...
  roble: {
    bone: "oklch(0.78 0.06 70)", boneEdge: "oklch(0.64 0.06 65)", pip: "oklch(0.3 0.05 50)",
  ...
  marmol: {
    bone: "oklch(0.94 0.008 250)", boneEdge: "oklch(0.82 0.012 250)", pip: "oklch(0.4 0.03 250)",
  ...
  cromo: {
    bone: "oklch(0.82 0.005 250)", boneEdge: "oklch(0.65 0.008 250)", pip: "oklch(0.35 0.02 250)",
  ...
  estelar: {
    bone: "oklch(0.25 0.04 280)", boneEdge: "oklch(0.16 0.04 280)", pip: "oklch(0.9 0.08 90)",
