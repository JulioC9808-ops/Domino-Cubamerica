...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      claim_free_time: { Args: never; Returns: number }
      create_room: {
        Args: {
          _flag: string
          _is_private: boolean
      ...
      generate_bracket: { Args: { p_tournament: string }; Returns: number }
      ...
      join_tournament:
        | { Args: { p_tournament: string }; Returns: undefined }
        | {
            Args: { p_partner?: string; p_tournament: string }
            Returns: undefined
          }
      report_match_result: {
        Args: { p_match: string; p_winners: string[] }
        Returns: undefined
      }
      spend_play_time: { Args: never; Returns: number }
      start_play_session: { Args: { p_game?: string }; Returns: string }
    }
    Enums: {
      [_ in never]: never
    }
